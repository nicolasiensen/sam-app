# To-do
- Introduce Typescript to the project
- Hot reload in the local environment
...
The command installs dependencies that are defined in `package.json`, creates a deployment package, and saves it in the `.aws-sam/build` folder.
...
- [How to run API Gateway, AWS Lambda and DynamoDB locally](https://andmoredev.medium.com/how-to-run-api-gateway-aws-lambda-and-dynamodb-locally-91b75d9a54fe): local DynamoDB setup